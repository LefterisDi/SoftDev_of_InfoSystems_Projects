...
void FilterBetweenTwoColumnsStats(TableStats& , TableStats& , uint64_t , uint64_t);
void FilterBetweenTwoValsStats(TableStats&  ,uint64_t , uint64_t , uint64_t);
void FilterEqualToValStats(TableStats&  , uint64_t , uint64_t);
